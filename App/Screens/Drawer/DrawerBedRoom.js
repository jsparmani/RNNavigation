...
class DrawerBedRoom extends Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
        ...
        return (
            ...
            <View style={{ margin: 18, flex: 1, justifyContent: 'center' }}>
                ...
                <View style={{ marginBottom: 18 }}>
                    ...
                    <Text>This is Drawer's BedRoom. Feel comportable and enjoy with all the stuffs here.</Text>
                </View>
                <Button
